...
export default function ExitIntent() {
  ...
  return (
    <div className="fixed bottom-20 sm:bottom-5 right-3 sm:right-5 z-[60] w-[360px] max-w-[calc(100vw-1.5rem)] animate-in slide-in-from-bottom-2 fade-in duration-300">
